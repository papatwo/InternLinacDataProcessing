...
%         end      
    ...
    if isempty(oppdd2x2)~=1    
        if oppdd2x2(1,5)>0
            ...
            while oppdd2x2(end,5)>0&&oppdd2x2(end,5)<300
                oppdd2x2(end,:)=[];
            end
        end
    end
...
%         end      
    ...
    if isempty(oppdd3x3)~=1    
        if oppdd3x3(1,5)>0
            ...
            while oppdd3x3(end,5)>0&&oppdd3x3(end,5)<300
                oppdd3x3(end,:)=[];
            end
        end
    end
...
%         end      
    ...
    if isempty(oppdd4x4)~=1    
        if oppdd4x4(1,5)>0
            ...
            while oppdd4x4(end,5)>0&&oppdd4x4(end,5)<300
                oppdd4x4(end,:)=[];
            end
        end
    end
...
%         end      
    ...
    if isempty(oppdd5x5)~=1    
        if oppdd5x5(1,5)>0
            ...
            while oppdd5x5(end,5)>0&&oppdd5x5(end,5)<300
                oppdd5x5(end,:)=[];
            end
        end
    end
...
%         end      
    ...
    if isempty(oppdd7x7)~=1    
        if oppdd7x7(1,5)>0
            ...
            while oppdd7x7(end,5)>0&&oppdd7x7(end,5)<300
                oppdd7x7(end,:)=[];
            end
        end
    end
...
%         end      
    ...
    if isempty(oppdd10x10)~=1    
        if oppdd10x10(1,5)>0
            ...
            while oppdd10x10(end,5)>0&&oppdd10x10(end,5)<300
                oppdd10x10(end,:)=[];
            end
        end
    end
...
%         end
    ...
    if isempty(oppdd15x15)~=1    
        if oppdd15x15(1,5)>0
            ...
            while oppdd15x15(end,5)>0&&oppdd15x15(end,5)<300
                oppdd15x15(end,:)=[];
            end
        end
    end
...
%         end      
    ...
    if isempty(oppdd20x20)~=1    
        if oppdd20x20(1,5)>0
            ...
            while oppdd20x20(end,5)>0&&oppdd20x20(end,5)<300
                oppdd20x20(end,:)=[];
            end
        end
    end
...
%         end      
    ...
    if isempty(oppdd30x30)~=1    
        if oppdd30x30(1,5)>0 % in case the measurement was taken from +ve to -ve
            ...
            while oppdd30x30(end,5)>0&&oppdd30x30(end,5)<300
                oppdd30x30(end,:)=[];
            end
        end
    end
